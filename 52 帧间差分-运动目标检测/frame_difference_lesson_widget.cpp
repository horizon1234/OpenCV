#include "frame_difference_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 52;
}

FrameDifferenceLessonWidget::FrameDifferenceLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void FrameDifferenceLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void FrameDifferenceLessonWidget::ensureTimer()
{
...
void FrameDifferenceLessonWidget::runDemo(int demoId)
{
