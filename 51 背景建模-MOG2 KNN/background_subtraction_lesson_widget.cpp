#include "background_subtraction_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 51;
}

BackgroundSubtractionLessonWidget::BackgroundSubtractionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void BackgroundSubtractionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void BackgroundSubtractionLessonWidget::ensureTimer()
{
...
void BackgroundSubtractionLessonWidget::runDemo(int demoId)
{
