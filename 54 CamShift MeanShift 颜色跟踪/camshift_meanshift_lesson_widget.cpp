#include "camshift_meanshift_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 54;
}

CamshiftMeanshiftLessonWidget::CamshiftMeanshiftLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void CamshiftMeanshiftLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void CamshiftMeanshiftLessonWidget::ensureTimer()
{
...
void CamshiftMeanshiftLessonWidget::runDemo(int demoId)
{
