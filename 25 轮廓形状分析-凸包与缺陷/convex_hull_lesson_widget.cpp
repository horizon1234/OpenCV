#include "convex_hull_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 25;
}

ConvexHullLessonWidget::ConvexHullLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ConvexHullLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void ConvexHullLessonWidget::ensureTimer()
{
...
void ConvexHullLessonWidget::runDemo(int demoId)
{
