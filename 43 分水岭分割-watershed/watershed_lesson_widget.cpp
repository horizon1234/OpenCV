#include "watershed_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 43;
}

WatershedLessonWidget::WatershedLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void WatershedLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void WatershedLessonWidget::ensureTimer()
{
...
void WatershedLessonWidget::runDemo(int demoId)
{
