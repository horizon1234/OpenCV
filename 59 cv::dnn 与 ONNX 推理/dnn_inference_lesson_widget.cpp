#include "dnn_inference_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 59;
}

DnnInferenceLessonWidget::DnnInferenceLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void DnnInferenceLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void DnnInferenceLessonWidget::ensureTimer()
{
...
void DnnInferenceLessonWidget::runDemo(int demoId)
{
