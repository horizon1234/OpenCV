#include "polygon_approx_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 26;
}

PolygonApproxLessonWidget::PolygonApproxLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void PolygonApproxLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void PolygonApproxLessonWidget::ensureTimer()
{
...
void PolygonApproxLessonWidget::runDemo(int demoId)
{
