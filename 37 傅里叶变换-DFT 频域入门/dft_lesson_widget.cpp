...
namespace
{
constexpr int kLessonId = 37;
}

DftLessonWidget::DftLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void DftLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void DftLessonWidget::ensureTimer()
{
...
void DftLessonWidget::runDemo(int demoId)
{
