#include "smoothing_filter_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 18;
}

SmoothingFilterLessonWidget::SmoothingFilterLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void SmoothingFilterLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void SmoothingFilterLessonWidget::ensureTimer()
{
...
void SmoothingFilterLessonWidget::runDemo(int demoId)
{
