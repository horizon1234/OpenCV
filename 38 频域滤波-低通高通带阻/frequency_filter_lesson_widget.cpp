#include "frequency_filter_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 38;
}

FrequencyFilterLessonWidget::FrequencyFilterLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void FrequencyFilterLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void FrequencyFilterLessonWidget::ensureTimer()
{
...
void FrequencyFilterLessonWidget::runDemo(int demoId)
{
