#include "optimization_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 60;
}

OptimizationLessonWidget::OptimizationLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void OptimizationLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void OptimizationLessonWidget::ensureTimer()
{
...
void OptimizationLessonWidget::runDemo(int demoId)
{
