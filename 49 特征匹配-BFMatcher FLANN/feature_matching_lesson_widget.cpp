#include "feature_matching_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 49;
}

FeatureMatchingLessonWidget::FeatureMatchingLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void FeatureMatchingLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void FeatureMatchingLessonWidget::ensureTimer()
{
...
void FeatureMatchingLessonWidget::runDemo(int demoId)
{
