...
namespace
{
constexpr int kLessonId = 22;
}

CannyLessonWidget::CannyLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void CannyLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void CannyLessonWidget::ensureTimer()
{
...
void CannyLessonWidget::runDemo(int demoId)
{
