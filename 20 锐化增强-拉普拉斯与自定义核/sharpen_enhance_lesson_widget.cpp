#include "sharpen_enhance_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 20;
}

SharpenEnhanceLessonWidget::SharpenEnhanceLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void SharpenEnhanceLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void SharpenEnhanceLessonWidget::ensureTimer()
{
...
void SharpenEnhanceLessonWidget::runDemo(int demoId)
{
