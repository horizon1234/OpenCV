#include "neighborhood_filter_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 17;
}

NeighborhoodFilterLessonWidget::NeighborhoodFilterLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void NeighborhoodFilterLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void NeighborhoodFilterLessonWidget::ensureTimer()
{
...
void NeighborhoodFilterLessonWidget::runDemo(int demoId)
{
