#include "undistort_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 57;
}

UndistortLessonWidget::UndistortLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void UndistortLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void UndistortLessonWidget::ensureTimer()
{
...
void UndistortLessonWidget::runDemo(int demoId)
{
