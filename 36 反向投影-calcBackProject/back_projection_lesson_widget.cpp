#include "back_projection_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 36;
}

BackProjectionLessonWidget::BackProjectionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void BackProjectionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void BackProjectionLessonWidget::ensureTimer()
{
...
void BackProjectionLessonWidget::runDemo(int demoId)
{
