#include "hough_lines_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 28;
}

HoughLinesLessonWidget::HoughLinesLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void HoughLinesLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void HoughLinesLessonWidget::ensureTimer()
{
...
void HoughLinesLessonWidget::runDemo(int demoId)
{
