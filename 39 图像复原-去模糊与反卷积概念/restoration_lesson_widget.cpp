#include "restoration_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 39;
}

RestorationLessonWidget::RestorationLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void RestorationLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void RestorationLessonWidget::ensureTimer()
{
...
void RestorationLessonWidget::runDemo(int demoId)
{
