#include "moments_centroid_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 27;
}

MomentsCentroidLessonWidget::MomentsCentroidLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void MomentsCentroidLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void MomentsCentroidLessonWidget::ensureTimer()
{
...
void MomentsCentroidLessonWidget::runDemo(int demoId)
{
