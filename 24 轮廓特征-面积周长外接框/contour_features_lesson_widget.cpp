#include "contour_features_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 24;
}

ContourFeaturesLessonWidget::ContourFeaturesLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ContourFeaturesLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void ContourFeaturesLessonWidget::ensureTimer()
{
...
void ContourFeaturesLessonWidget::runDemo(int demoId)
{
