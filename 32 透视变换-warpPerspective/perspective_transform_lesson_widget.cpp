#include "perspective_transform_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 32;
}

PerspectiveTransformLessonWidget::PerspectiveTransformLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void PerspectiveTransformLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void PerspectiveTransformLessonWidget::ensureTimer()
{
...
void PerspectiveTransformLessonWidget::runDemo(int demoId)
{
