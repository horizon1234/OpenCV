#include "corner_detection_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 47;
}

CornerDetectionLessonWidget::CornerDetectionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void CornerDetectionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void CornerDetectionLessonWidget::ensureTimer()
{
...
void CornerDetectionLessonWidget::runDemo(int demoId)
{
