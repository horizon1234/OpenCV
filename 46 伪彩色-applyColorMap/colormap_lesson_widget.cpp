#include "colormap_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 46;
}

ColormapLessonWidget::ColormapLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ColormapLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void ColormapLessonWidget::ensureTimer()
{
...
void ColormapLessonWidget::runDemo(int demoId)
{
