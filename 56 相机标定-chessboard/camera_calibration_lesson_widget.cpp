#include "camera_calibration_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 56;
}

CameraCalibrationLessonWidget::CameraCalibrationLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void CameraCalibrationLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void CameraCalibrationLessonWidget::ensureTimer()
{
...
void CameraCalibrationLessonWidget::runDemo(int demoId)
{
