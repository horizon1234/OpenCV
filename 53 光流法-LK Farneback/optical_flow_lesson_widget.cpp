#include "optical_flow_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 53;
}

OpticalFlowLessonWidget::OpticalFlowLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void OpticalFlowLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void OpticalFlowLessonWidget::ensureTimer()
{
...
void OpticalFlowLessonWidget::runDemo(int demoId)
{
