#include "grabcut_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 44;
}

GrabcutLessonWidget::GrabcutLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void GrabcutLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void GrabcutLessonWidget::ensureTimer()
{
...
void GrabcutLessonWidget::runDemo(int demoId)
{
