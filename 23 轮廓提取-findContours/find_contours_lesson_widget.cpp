#include "find_contours_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 23;
}

FindContoursLessonWidget::FindContoursLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void FindContoursLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void FindContoursLessonWidget::ensureTimer()
{
...
void FindContoursLessonWidget::runDemo(int demoId)
{
