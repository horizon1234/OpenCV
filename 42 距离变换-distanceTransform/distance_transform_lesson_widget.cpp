#include "distance_transform_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 42;
}

DistanceTransformLessonWidget::DistanceTransformLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void DistanceTransformLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void DistanceTransformLessonWidget::ensureTimer()
{
...
void DistanceTransformLessonWidget::runDemo(int demoId)
{
