#include "gradient_detection_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 21;
}

GradientDetectionLessonWidget::GradientDetectionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void GradientDetectionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void GradientDetectionLessonWidget::ensureTimer()
{
...
void GradientDetectionLessonWidget::runDemo(int demoId)
{
