#include "denoise_filter_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 19;
}

DenoiseFilterLessonWidget::DenoiseFilterLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void DenoiseFilterLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void DenoiseFilterLessonWidget::ensureTimer()
{
...
void DenoiseFilterLessonWidget::runDemo(int demoId)
{
