#include "resize_interpolation_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 30;
}

ResizeInterpolationLessonWidget::ResizeInterpolationLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ResizeInterpolationLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void ResizeInterpolationLessonWidget::ensureTimer()
{
...
void ResizeInterpolationLessonWidget::runDemo(int demoId)
{
