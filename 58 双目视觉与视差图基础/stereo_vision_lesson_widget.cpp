#include "stereo_vision_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 58;
}

StereoVisionLessonWidget::StereoVisionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void StereoVisionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void StereoVisionLessonWidget::ensureTimer()
{
...
void StereoVisionLessonWidget::runDemo(int demoId)
{
