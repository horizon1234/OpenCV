#include "hough_circles_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 29;
}

HoughCirclesLessonWidget::HoughCirclesLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void HoughCirclesLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void HoughCirclesLessonWidget::ensureTimer()
{
...
void HoughCirclesLessonWidget::runDemo(int demoId)
{
