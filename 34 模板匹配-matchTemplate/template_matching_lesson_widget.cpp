#include "template_matching_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 34;
}

TemplateMatchingLessonWidget::TemplateMatchingLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void TemplateMatchingLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void TemplateMatchingLessonWidget::ensureTimer()
{
...
void TemplateMatchingLessonWidget::runDemo(int demoId)
{
