#include "blending_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 45;
}

BlendingLessonWidget::BlendingLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void BlendingLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void BlendingLessonWidget::ensureTimer()
{
...
void BlendingLessonWidget::runDemo(int demoId)
{
