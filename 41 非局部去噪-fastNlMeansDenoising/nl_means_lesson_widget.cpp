#include "nl_means_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 41;
}

NlMeansLessonWidget::NlMeansLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void NlMeansLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void NlMeansLessonWidget::ensureTimer()
{
...
void NlMeansLessonWidget::runDemo(int demoId)
{
