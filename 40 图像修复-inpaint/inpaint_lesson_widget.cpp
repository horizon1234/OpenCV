#include "inpaint_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 40;
}

InpaintLessonWidget::InpaintLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void InpaintLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void InpaintLessonWidget::ensureTimer()
{
...
void InpaintLessonWidget::runDemo(int demoId)
{
