#include "homography_stitching_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 55;
}

HomographyStitchingLessonWidget::HomographyStitchingLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void HomographyStitchingLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void HomographyStitchingLessonWidget::ensureTimer()
{
...
void HomographyStitchingLessonWidget::runDemo(int demoId)
{
