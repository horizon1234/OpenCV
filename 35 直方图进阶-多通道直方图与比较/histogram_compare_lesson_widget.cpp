#include "histogram_compare_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 35;
}

HistogramCompareLessonWidget::HistogramCompareLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void HistogramCompareLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void HistogramCompareLessonWidget::ensureTimer()
{
...
void HistogramCompareLessonWidget::runDemo(int demoId)
{
