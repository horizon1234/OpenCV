#include "geometric_transform_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 31;
}

GeometricTransformLessonWidget::GeometricTransformLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void GeometricTransformLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void GeometricTransformLessonWidget::ensureTimer()
{
...
void GeometricTransformLessonWidget::runDemo(int demoId)
{
