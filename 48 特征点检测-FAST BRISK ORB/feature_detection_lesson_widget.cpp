#include "feature_detection_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 48;
}

FeatureDetectionLessonWidget::FeatureDetectionLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void FeatureDetectionLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void FeatureDetectionLessonWidget::ensureTimer()
{
...
void FeatureDetectionLessonWidget::runDemo(int demoId)
{
