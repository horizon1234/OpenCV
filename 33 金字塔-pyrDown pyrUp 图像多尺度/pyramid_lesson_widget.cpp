#include "pyramid_lesson_widget.h"
...
namespace
{
constexpr int kLessonId = 33;
}

PyramidLessonWidget::PyramidLessonWidget(QWidget *parent)
    : QWidget(parent)
{
...
void PyramidLessonWidget::buildButtons()
{
    const auto &config = advancedLessonConfig(kLessonId);
...
void PyramidLessonWidget::ensureTimer()
{
...
void PyramidLessonWidget::runDemo(int demoId)
{
